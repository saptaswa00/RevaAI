...
catmodel = pickle.load(open("./models/RainCatb_model.pkl","rb"))
print("Model Loaded")
...
def predict():
    if request.method == "POST":
        ...
        input_list = [location,minTemp,maxTemp, rainfall, evaporation, sunshine, windGustDir , windGustSpeed , 
                    windDir9am , windDir3pm , windSpeed9am , windSpeed3pm ,humidity9am , humidity3pm, 
                    pressure9am, pressure3pm, cloud9am, cloud3pm, temp9am, temp3pm, rainToday,year, month, day]
        
        pred = catmodel.predict(input_list)
        output = pred
